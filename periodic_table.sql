...
--
-- Name: elements unique_name_key; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--
...
--
-- Name: elements unique_symbol_key; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT unique_symbol_key UNIQUE (symbol);
